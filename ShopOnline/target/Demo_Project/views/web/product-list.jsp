				...
				<!-- PRODUCT ITEM START -->
				 <div class="col-md-4 col-sm-6 col-xs-12">
					<div class="product-item">
						...
						<a href="<c:url value="/member/cart/add?pId=${proList.productId}&quantity=1"/>" class="btn btn-default add2cart" class="btn btn-default add2cart">Add to cart</a>
					</div>
				</div> 
				<!-- PRODUCT ITEM END -->
									...
									<div class="col-md-6 col-sm-6 col-xs-9">
										...
										<div class="product-page-cart">
											<form name="f1" method="get"
												...
												<input type="text" id="stock${proList.productId}" value="${proList.stoke}" hidden="">
				...
				<div class="row">
					...
					<div class="col-md-8 col-sm-8">
						<ul class="pagination pull-right">
							<c:if test="${tag>1 }">
								<li><a
									href="${pageContext.request.contextPath}/product/list?index=${tag-1}&categoryId=${categoryId}&sellerId=0">&laquo;</a></li>
							</c:if>

							<c:forEach begin="1" end="${endP}" var="i">
								<li class='${tag==i?"active":""}'><a
									href="${pageContext.request.contextPath}/product/list?index=${i}&categoryId=${categoryId}&sellerId=0">${i}</a></li>
							</c:forEach>

							<c:if test="${tag<endP}">
								<li><a
									href="${pageContext.request.contextPath}/product/list?index=${tag+1}&${categoryId}&sellerId=0">&laquo;</a></li>
							</c:if>
						</ul>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-8 col-sm-8">
						<ul class="pagination pull-right">
							<c:if test="${tag>1 }">
								<li><a
									href="${pageContext.request.contextPath}/product/list?index=${tag-1}&categoryId=0&sellerId=${sellerId}">&laquo;</a></li>
							</c:if>

							<c:forEach begin="1" end="${endP}" var="i">
								<li class='${tag==i?"active":""}'><a
									href="${pageContext.request.contextPath}/product/list?index=${i}&categoryId=0&sellerId=${sellerId}">${i}</a></li>
							</c:forEach>
