...
<head>
  ...
  <link href="${url}/global/plugins/slider-layer-slider/css/layerslider.css" rel="stylesheet">
  <!-- Page level plugin styles END -->

  <!-- Theme styles START -->
  <link href="${url}/global/css/components.css" rel="stylesheet">
  <link href="${url}/frontend/layout/css/style.css" rel="stylesheet">
  <link href="${url}/frontend/pages/css/style-shop.css" rel="stylesheet" type="text/css">
  <link href="${url}/frontend/pages/css/style-layer-slider.css" rel="stylesheet">
